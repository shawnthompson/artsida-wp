<?php get_header(); ?>
		...
		<div class="cell">
			...
			<div class="hidden-xs col-sm-5 col-md-6 purple responsive"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/pic4.jpg" class="bottom-right photoh" alt=""></div>
